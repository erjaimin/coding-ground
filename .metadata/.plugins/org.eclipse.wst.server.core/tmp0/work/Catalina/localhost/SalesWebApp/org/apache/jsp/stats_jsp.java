 ...
 * Generated at: 2017-11-28 19:32:34 UTC
 ...
 String query1 = "SELECT CUSTOMER.CUSTOMER_ID, CUSTOMER.CUSTOMER_NAME "+ 
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	try{	
      ...
      out.write("\t\t}\n");
      out.write("\t\t.button1:hover {background-color: #e7e7e7;}\n");
      out.write("\t\t.button2 {\n");
      ...
      out.write("\t\t\t\tif(localStorage.getItem('view')){\n");
      out.write("\t\t\t\t\tgraphView();\n");
      out.write("\t\t\t\t}else{\n");
      out.write("\t\t\t\t\ttableView();\n");
      out.write("\t\t\t\t}\n");
...
if(counter2 +1 < noOfProducts){counter2++;
      ...
      out.write("\t\t\t\twindow.location.replace(\"stats.jsp?client=\" + selectedValue);\n");
      out.write("\t\t\t}else{\n");
      out.write("\t\t\t\twindow.location.replace(\"stats.jsp?client=&\");\n");
      out.write("\t\t\t}\n");
      out.write("\t\t}\n");
      out.write("\t\t\n");
      out.write("\t\tfunction tableView(){\n");
      out.write("\t\t\tdocument.getElementById('tableView').style.display = \"block\";\n");
      out.write("\t\t\tdocument.getElementById('graphView').style.display = \"none\";\n");
      out.write("\t\t\tdocument.getElementById('btnTable').classList.add(\"button1\");\n");
      out.write("\t\t\tdocument.getElementById('btnGraph').classList.add(\"button2\");\n");
      out.write("\t\t\tdocument.getElementById('btnTable').classList.remove(\"button2\");\n");
      out.write("\t\t\tdocument.getElementById('btnGraph').classList.remove(\"button1\");\n");
      ...
      out.write("\t\t\tdocument.getElementById('graphView').style.display = \"block\";\n");
      out.write("\t\t\tdocument.getElementById('btnTable').classList.add(\"button2\");\n");
      out.write("\t\t\tdocument.getElementById('btnTable').classList.add(\"button1\");\n");
      out.write("\t\t\tdocument.getElementById('btnGraph').classList.add(\"button1\");\n");
      out.write("\t\t\tdocument.getElementById('btnGraph').classList.remove(\"button2\");\n");
      ...
      out.write("\t\t<label for=\"customerDropDown\" style=\"font-size: medium; font-weight: bold;\">Client : </label>\n");
      out.write("\t\t<select id=\"customerDropDown\" name=\"customerDropDown\" onchange=\"fetchClientDetails(this);\">\n");
...
if(clients != null){ 
      ...
      out.write("\n");
      out.write("\t\t</select> \n");
      out.write("\t\t<input type=\"button\" id=\"btnTable\" value=\"Table\" class=\"button\" onclick=\"tableView();\"/> \n");
      out.write("\t\t<input type=\"button\" id=\"btnGraph\" value=\"Graph\" class=\"button\" onclick=\"graphView();\"/>\n");
      out.write("\t</div>\n");
