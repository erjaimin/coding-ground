	...
	public Integer tester() {
		...
		try {
			...
			for (Integer i = 0; i < testCount; i++) {
				...
				if (removedNode == null || !removedNode.getKey().equals(r) || !removedNode.getValue().equals(r + 1)) {
		...
		try {
			...
			for (Integer i = 0; i < 4; i++) {
				...
				if (removedNode == null || !removedNode.getKey().equals(4 - i - 1)
		...
		try {
			...
			if (returnedNode == null || !returnedNode.getKey().equals(0) || !returnedNode.getValue().equals(1)) {
