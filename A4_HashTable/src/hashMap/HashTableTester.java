...
public class HashTableTester {
	...
	public static void main(String[] args) {
		...
		songs = new ArrayList<>();
		songs.add(new Song("Scream", "Max Richter", 1968));
		songs.add(new Song("Away", "Justin", 2010));
		songs.add(new Song("Locked out of heaven", "Bruno Mars", 2013));
		songs.add(new Song("Despacito", "Luis Fonsi", 2017));
		songs.add(new Song("Uptown Funk", "Bruno", 2016));
		for (Song song: songs) {
			songTable.put(song.getTitle(), song);
		}
